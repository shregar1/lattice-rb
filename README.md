...
- **Mandatory DTO Inter-Layer Data Transfer**: Raw untyped JSON is never passed across layer boundaries. All data transfer uses strongly-typed Ruby DTO objects (`BaseDTO`).
...
We urge open-source developers to contribute! Please review `docs/plans/`, pick an open blueprint, submit PRs, and help expand the Ruby edition of Lattice.
